                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="flex flex-col">
                                ...
                                <input type="text" value={formData.studentID} readOnly className="bg-gray-100 p-2 border-b-2 border-black" />
                            </div>
                            <div className="flex flex-col">
                        ...
                        {/* PHOTO BOX */}
                        <div className="w-full md:w-48 flex flex-col items-center border-2 border-dashed border-gray-400 p-2">
                            <span className="text-[10px] font-bold mb-2 uppercase">Photo</span>
                            <div className="w-32 h-32 bg-gray-200 border-2 border-black relative">
                                {formData.pupilPhoto && <img src={formData.pupilPhoto} className="w-full h-full object-cover" alt="pupil" />}
                            </div>
                            <label className="mt-3 cursor-pointer bg-black text-white px-3 py-1 text-[10px] font-bold uppercase">
                                Upload Photo
                                <input type="file" className="hidden" onChange={(e) => handleFileUpload(e, "pupil")} />
                            </label>
                        </div>
                    </div>

                    <button disabled={isSubmitting} type="submit" className="w-full bg-black text-white p-3 font-bold hover:bg-gray-800">
                        {isSubmitting ? "PROCESSING..." : editingId ? "UPDATE RECORD" : "REGISTER STUDENT"}
                    </button>
                </form>
