...
import JSS2periodAtt from "../TeacherAssignment/JSS2periodAtt";
...
// --- Main Admin Panel ---
function SupervisorJssTwoDashboard() {
    ...
    const renderContent = () => {
        switch (activeTab) {
            ...
            case "JSS2periodAtt": return <JSS2periodAtt />;
...
export default SupervisorJssTwoDashboard;
