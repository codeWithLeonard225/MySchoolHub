  ...
  >
   {/* Header (Maroon/Yellow) */}
    <div
      ...
      style={{
        background: "linear-gradient(90deg, #800000, #990000)", // Maroon gradient
        color: "yellow",
        padding: "3px 0",
      }}
    >
    ...
    >
      ...
      />
      <div className="flex flex-col justify-center text-[8.8pt] font-medium leading-[1.9]">
        {/* Text is now Maroon by inheritance, but let's ensure strong contrast for bold labels */}
        <p>
          <strong style={{ color: '#600000' }}>ID:</strong> {studentData.studentID}
        </p>
        <p>
          <strong style={{ color: '#600000' }}>Name:</strong> {studentData.studentName}
        </p>

        <p>
          <strong style={{ color: '#600000' }}>Class:</strong>{" "}
          {studentData.class ? studentData.class.slice(0, 3).toUpperCase() : "N/A"}
        </p>

        <p>
          <strong style={{ color: '#600000' }}>DOB:</strong> {formatDate(studentData.dob)}
        </p>
        <p>
          <strong style={{ color: '#600000' }}>Address:</strong> {studentData.addressLine1}
        </p>
      </div>
    </div>
...
export default ModelSchoolIdCard;
