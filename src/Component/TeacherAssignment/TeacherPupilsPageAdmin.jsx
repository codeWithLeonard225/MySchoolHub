...
// Assuming schooldb is where PupilGrades lives. If they are the same, just use 'db'.
// I will keep 'schooldb' for PupilGrades as per your original code.
...
const GradesAuditPage = () => {
    ...
    // Not needed in this view, as grades are managed individually, not submitted in a batch.
